...
class DataSpeech():
    ...
    def LoadDataList(self):
        ...
        if (self.type == 'train'):
            ...
            # children data
            filename_wavlist_child = "child" + self.slash + "train.wav.txt"
            filename_symbollist_child = "child" + self.slash + "train.syllable.txt"
        elif (self.type == 'dev'):
            ...
            # children data
            filename_wavlist_child = "child" + self.slash + "dev.wav.txt"
            filename_symbollist_child = "child" + self.slash + "dev.syllable.txt"
        elif (self.type == 'test'):
            ...
            # children data
            filename_wavlist_child = "child" + self.slash + "test.wav.txt"
            filename_symbollist_child = "child" + self.slash + "test.syllable.txt"
        else:
        ...
        self.dic_wavlist_child, self.list_wavnum_child = get_wav_list(self.datapath + filename_wavlist_child)
        self.dic_symbollist_child, self.list_symbolnum_child = get_wav_symbol(self.datapath + filename_symbollist_child)
    ...
    def GetDataNum(self):
        ...
        num_wavlist_child = len(self.dic_wavlist_child)
        num_symbollist_child = len(self.dic_symbollist_child)
        if (num_wavlist_child == num_symbollist_child):
            DataNum = num_wavlist_child
        else:
            DataNum = -1
    ...
    def GetData(self, n_start, n_amount=1):
        ...
        # 读取一个文件
        length = len(self.list_wavnum_child)
        filename = self.dic_wavlist_child[self.list_wavnum_child[n_start % length]]
        list_symbol = self.dic_symbollist_child[self.list_symbolnum_child[n_start % length]]
        ...
        for i in list_symbol:
            if ('' != i):
                ...
                # feat_out.append(v)
                feat_out.append(n)
        assert (len(feat_out) <= 64)
        # print('feat_out:',len(feat_out))
...
if (__name__ == '__main__'):
    path = 'dataset'
    l = DataSpeech(path=path, type='test')
    l.LoadDataList()
    print(l.GetDataNum())
    print(l.GetData(0))
    l.TestData()
